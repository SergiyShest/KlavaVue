...
export function WordEx(dictName) {
  ...
  Dicti[counerNam]++;
  if ((Dicti[counerNam] = Dicti[dictName].length)) {
    //if and of array
    Dicti[counerNam] = 0;
  }
  return word;
...
export function TRANSLATE(txt, dir = "ru-en") {
  ...
  var key =
    "trnsl.1.1.20190324T133417Z.c2eddb7568471f8d.219fc4005536b04ae17e029f51e3438ac66e5001";
  var url =
...
export function AddPlace() {
  ...
  if (ind == 0) {
    return " на " + WordEx("PlasesOn");
  }
  if (ind == 1) {
    return " в " + WordEx("PlasesIn");
  }
  if (ind == 2) {
    return " под " + WordEx("PlasesUnder");
  }
}
...
function GetSentation(short = false) {
  ...
  if (sentType === 0) {
    sentence = GetSentationM();
  }
  if (sentType === 1) {
    sentence = GetSentationW();
  }
  if (sentType === 2) {
    sentence = GetSentation3();
  }
  if (sentType === 3) {
    sentence = GetSentation4();
  }
  if (sentType === 4) {
    sentence = GetSentation5();
  }
  if (sentType === 5) {
    sentence = GetSentation6();
  }
  if (sentType === 6) {
    sentence = GetSentation7();
  }
  if (sentType === 7) {
    sentence = GetSentationW();
  }
  ...
  var sentence =
    sentence[0].toUpperCase() + sentence.substr(1, sentence.length);
  return sentence;
}
