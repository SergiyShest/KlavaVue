...
<script>
    ...
    export default {
        ...
        data() {
            return {
                row1: [{ code: "Backquote", sh: 'ё', isPressed: false, highlight: false },
                ...
                row2: [{ code: "KeyQ", sh: "й", isPressed: false, highlight: false }, { code: "KeyW", sh: 'ц', isPressed: false, highlight: false }, { code: "KeyE", sh: 'у', isPressed: false, highlight: false },
                ...
                row3: [{ code: "KeyA", sh: 'ф', isPressed: false, highlight: false }, { code: "KeyS", sh: 'ы', isPressed: false, highlight: false }, { code: "KeyD", sh: 'в', isPressed: false, highlight: false },
                ...
                row4: [{ code: "KeyZ", sh: 'я', isPressed: false, highlight: false }, { code: "KeyX", sh: 'ч', isPressed: false, highlight: false }, { code: "KeyC", sh: 'с', isPressed: false, highlight: false },
                ...
                row5: [{ code: "Ctrl", sh: 'Ctrl', isPressed: false, highlight: false }, { code: "fn", sh: 'fn', isPressed: false, highlight: false }, { code: "Win", sh: 'Win', isPressed: false, highlight: false },
        ...
        , methods: {
            setButtonPressed: function (code, pressed) {
                var item = this.row1.find(function (v) { return v.code == code; });
                if (item != undefined) {
                    item.isPressed = pressed;
                }
                else {
                    item = this.row2.find(function (v) { return v.code == code; });
                    if (item != undefined) {
                        item.isPressed = pressed;
                    }
                    else {
                        item = this.row3.find(function (v) { return v.code == code; });
                        if (item != undefined) {
                            item.isPressed = pressed;
                        }
                        else {
                            item = this.row4.find(function (v) { return v.code == code; });
                            if (item != undefined) {
                                item.isPressed = pressed;
                            }
                            else {
